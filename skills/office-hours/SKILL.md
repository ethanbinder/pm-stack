...
name: office-hours
description: >-
  Start here. Six forcing questions that reframe your product before you write
  code. Pushes back on your framing, challenges premises, generates
...
6. **Future-Fit** — In 18 months, why does this still matter? What's changing in the market, the tech stack, or user behavior that makes this inevitable rather than optional? If the answer is "it's still nice to have," that's a downgrade, not a pass.
...
For each alternative, capture: a one-sentence pitch, who it's for, upside if it works, the biggest risk. Include the PM Builder's original framing as one of the options if it deserves a seat at the table, but do not default to it.
...
If the PM Builder hesitates, recommend a mode based on what surfaced in Phases 2–4 and explain why.
...
| Pitch | Audience | Upside | Biggest Risk |
|-------|----------|--------|--------------|
| [One-sentence pitch] | [Specific user/segment] | [What happens if this works] | [What kills it] |
| ... | ... | ... | ... |
